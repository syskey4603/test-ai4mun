...
async function test() {
  ...
  const prompt = "5 specific instances with details of the actual example of the violations by " + country.value + " in regards to the legality of " + legality.value + "make it very detailed and expand on the real life example cite your sources too with the link and leave a line between each point";
